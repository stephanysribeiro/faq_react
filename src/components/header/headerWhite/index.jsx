      ...
      <nav className={`navbar fixed-top ${styles.containerNav}`}>
        <div className={`container-fluid ${styles.containerFluid}`}>
          <a className={`navbar-brand ${styles.navbarBrand}`} href="#">
            <img src={HorseBlack} className={`navbar-logo ${styles.navbarLogo}`} />
          </a>
          ...
          <div className={`offcanvas offcanvas-top  ${styles.offcanvas}`} tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            <div className={`offcanvas-header ${styles.offcanvasHeader}`}>
              <h5 className={`offcanvas-title ${styles.offcanvasTitle}`} id="offcanvasNavbarLabel">
                <img src={HorseWhite} className={`offcanvas-logo ${styles.offcanvasLogo}`} />
              </h5>
